...
public interface TransactionalMessageService {
    ...
    /**
     * Process prepare message, in common, we should put this message to storage service.进程准备消息，通常，我们应该把这个消息存储到服务。
     *
    ...
    /**
     * Delete prepare message when this message has been committed or rolled back.在提交或回滚此消息时删除准备消息。
     *
     * @param messageExt
     */
     ...
     * status.遍历未提交/回滚一半消息并向生产者发送检查请求以获得事务状态。
     *
