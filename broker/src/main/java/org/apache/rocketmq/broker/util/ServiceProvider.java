...
public class ServiceProvider {
    ...
    /**
     * A reference to the classloader that loaded this class. It's more efficient to compute it once and cache it here.对装入该类的类装入器的引用。计算一次并将其缓存到这里更有效。
     */
     ...
     * 返回唯一标识指定对象(包括其类)的字符串。
    返回的字符串形式为“classname@hashcode”，ie与object .toString()方法的返回值相同，但即使指定对象的类覆盖了toString方法，也能工作。
     */
