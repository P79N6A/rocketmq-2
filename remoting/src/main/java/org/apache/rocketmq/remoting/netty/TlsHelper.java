...
public class TlsHelper {
    ...
    public interface DecryptionStrategy {
        /**
         * Decrypt the target encrpted private key file.解密目标加密的私钥文件。
         *
...
//    mark
    ...
    /**
     * Determine if a string is {@code null} or {@link String#isEmpty()} returns {@code true}. 确定字符串是null还是string . isempty()返回true。
     */
