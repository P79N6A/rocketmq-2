 ...
 * </p>
 * 表示一个常数表达式
 这个类来自ActiveMQ org.apache.activemq.filter。ConstantExpression,但是:1。对于长类型常量，java长类型所限定的范围;2。对于浮点类型常量，java双类型的范围限制;3所示。去掉十六进制和八进制的表达式;4所示。现在添加表达式来支持当前时间。
 */
//
...
//
     ...
     * it was provided in a selector.对字符串的值进行编码，使其看起来像在选择器中提供的那样。
     */
