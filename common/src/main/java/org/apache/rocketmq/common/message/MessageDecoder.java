...
//
    public static MessageExt decode(
        ...
        try {
            ...
            // 6 QUEUEOFFSET 查询offset
            long queueOffset = byteBuffer.getLong();
            msgExt.setQueueOffset(queueOffset);

            // 7 PHYSICALOFFSET 物理offset
