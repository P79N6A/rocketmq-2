...
//        3s超时=》
     ...
     * 它将在4.4.0时被删除，这将导致异常处理和超时的错误语义。下一个版本将提供一个新版本
     */
//
    @Deprecated
...
//
    ...
    /**
     * It will be removed at 4.4.0 cause for exception handling and the wrong Semantics of timeout.
     * A new one will be provided in next version 它将在4.4.0时被删除，这将导致异常处理和超时的错误语义。下一个版本将提供一个新版本
     * @param msg
     * @param mq
     * @param sendCallback
     * @param timeout the <code>sendCallback</code> will be invoked at most time
